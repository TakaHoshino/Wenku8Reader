// 移植自 SukiSU-Ultra 的 ui/component/miuix/animation/DampedDragAnimation.kt
...
/**
 * 带阻尼的拖动动画：底栏滑块用它实现"按下跟手、松手吸附、按住时膨胀"。
 *
 * 与 `Animatable` 的区别在于它同时维护速度、按压进度与 X/Y 两个方向的缩放，
 * 并由 [modifier] 统一挂上拖动手势。
 */
